...
# Paths
REAL_DATA_FILE     = os.path.join(os.path.dirname(__file__), "backend", "data", "india_real_data.csv")
UPLOADED_DATA_FILE = os.path.join(os.path.dirname(__file__), "backend", "data", "uploaded_data.csv")
